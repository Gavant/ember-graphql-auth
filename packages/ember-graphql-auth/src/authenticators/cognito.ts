...
import { LOGIN, LoginMutation, LoginMutationVariables } from 'mutations/login';
import { LOGOUT, LogoutMutation, LogoutMutationVariables } from 'mutations/logout';
import { REFRESH_TOKEN, RefreshTokenMutation, RefreshTokenMutationVariables } from 'mutations/refresh-token';
